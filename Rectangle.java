...
public class Rectangle {
    ...
    *Models a simple, solid rectangle.*This class represents a Rectabgle
                          object.When combined with the GameArena
    *class, instances of the Rectangle
    ...
    */ public class Rectangle {
        ...
        /**
         * Constructor. Creates a Rectangle with the given parameters.
         * @param x The x co-ordinate position of top left corner of the
         *     Rectangle (in pixels)
         * @param y The y co-ordinate position of top left corner of the
         *     Rectangle (in pixels)
         * @param w The width of the Rectangle (in pixels)
         * @param h The height of the Rectangle (in pixels)
         * @param col The colour of the Rectangle (Permissable colours are:
         *     BLACK, BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA,
         ...
         *     BLACK, BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA,
         *     ORANGE, PINK, RED, WHITE, YELLOW or #RRGGBB)
         * @param layer The layer this Rectangle is to be drawn on. Objects with
         *     a higher layer number are always drawn on top of those with lower
         *     layer numbers.
         */
        public Rectangle(double x, double y, double w, double h, String col,
                         int layer) {
        ...
        /**
         * Moves the current position of this Rectangle to the given X
         * co-ordinate
         * @param x the new x co-ordinate of this Rectangle
         */
        public void setXPosition(double x) {
        ...
        /**
         * Moves the current position of this Rectangle to the given Y
         * co-ordinate
         * @param y the new y co-ordinate of this Rectangle
         */
        public void setYPosition(double y) {
        ...
        public void setXOrigin(double o) {
            xOrigin = o;
        }
        ...
        public void setYOrigin(double o) {
            yOrigin = o;
        }
         ...
         *     Permissable colours are: BLACK, BLUE, CYAN, DARKGREY, GREY,
         *     GREEN, LIGHTGREY, MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW.
         */
        public void setColour(String c) {
            colour = c;
        }
